...
def main():
    ...
    if has_gpu:
        ...
        subprocess.check_call([sys.executable, "-m", "pip", "install", "torch==2.2.2", "torchaudio==2.2.2", "--index-url", "https://download.pytorch.org/whl/cu118"])
    else:
        ...
        subprocess.check_call([sys.executable, "-m", "pip", "install", "torch==2.2.2", "torchaudio==2.2.2"])
